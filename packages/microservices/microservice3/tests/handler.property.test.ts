...
//
// Here the router under test is microservice3's: P is its exported `path` and N
// is "microservice3". The module exports no identifier (the directory name is
...
const EXPECTED_NAME = "microservice3";
...
describe("Property 1: microservice3 endpoint contract at the mount path", () => {
